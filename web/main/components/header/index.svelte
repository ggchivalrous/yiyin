...
<div class="app-header">
  ...
  <Popup class="no-drag app-header-show grass button app-header-reset" on:click={resetConfig}>
  ...
  <div class="no-drag app-header-show grass button" on:click={miniSizeWindow} on:keypress role="button" tabindex="-1">-</div>
  <div class="no-drag app-header-close grass button" on:click={closeApp} on:keypress role="button" tabindex="-1">x</div>
</div>
